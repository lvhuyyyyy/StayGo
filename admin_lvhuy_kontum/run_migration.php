 ...
 * Truy cập: /admin_lvhuy_kontum/run_migration.php?token=staygo_migrate_2026
 */
...
<p style="margin-top:20px;color:#64748b;font-size:.8rem">
    Sau khi OK, xóa: <code style="color:#fbbf24">admin_lvhuy_kontum/run_migration.php</code>
</p>
</body>
</html>
